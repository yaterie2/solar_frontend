...
const textures = {
  Mercury: textureLoader.load("public/images/mercury2k.jpg"),
  Venus: textureLoader.load("public/images/2k_venus_surface.jpg"),
  Earth: textureLoader.load("public/images/2k_earth_daymap.jpg"),
  Mars: textureLoader.load("public/images/2k_mars.jpg"),
  Jupiter: textureLoader.load("public/images/2k_jupiter.jpg"),
  Saturn: textureLoader.load("public/images/2k_saturn.jpg"),
  Uranus: textureLoader.load("public/images/2k_uranus.jpg"),
  Neptune: textureLoader.load("public/images/2k_neptune.jpg"),
  Pluto: textureLoader.load("public/images/plutomap2k.jpg"),
  Sonne: textureLoader.load("public/images/2k_sun.jpg"),
};
